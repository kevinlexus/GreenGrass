 ...
 * 
 */
@WebServiceClient(name = "InfrastructureServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/infrastructure-service-async/", wsdlLocation = "file:/C:/work/GIS_MUP/GIS11_5/hcs_wsdl_xsd_v.11.0.0.5/infrastructure/hcs-infrastructure-service-async.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/work/GIS_MUP/GIS11_5/hcs_wsdl_xsd_v.11.0.0.5/infrastructure/hcs-infrastructure-service-async.wsdl");
