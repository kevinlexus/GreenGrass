...
public interface KartMng  {
	...
	public abstract void getCntPers(int rqn, Calc calc, RegContains rc, Serv serv, CntPers cntPers, Date genDt);
	public abstract Double getServPropByCD(int rqn, Calc calc, Serv serv, String string, Date genDt);
	public abstract Standart getStandartVol(int rqn, Calc calc, Serv serv, CntPers cntPers, Date genDt) throws EmptyStorable;
